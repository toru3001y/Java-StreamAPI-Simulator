...
/** Phase 3 PC幅キャプチャ（指示§14・§15の証跡。現行Phase以外では書込みせず操作確認のみ） */
test('p3-capture-pc: PC幅の画面キャプチャを保存する', async ({ page }) => {
  ...
  await captureArtifact(page, 3, 'capture-pc-distinct.png')
